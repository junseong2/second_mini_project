...
public class SecurityFilterChainConfig {
     ...
     public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		 ...
		 http.authorizeHttpRequests((auth)->
		 							auth.requestMatchers("/main","/signup","/idCheck","/login","/goodsRetrieve","/WEB-INF/**", "/manager","/search","/goodsRegister","/findid","/updatepw","/goodsList","/list","/retrieve","/updateBoard").permitAll()
